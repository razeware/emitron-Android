...
data class GroupEpisodeJoin(
  ...
  companion object {
    ...
    /**
     * List of [GroupEpisodeJoin] from [com.raywenderlich.emitron.model.Content]
     */
    fun listFrom(content: com.raywenderlich.emitron.model.Content): List<GroupEpisodeJoin> =
